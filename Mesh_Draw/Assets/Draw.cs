...
{
    public SteamVR_Action_Boolean Trigger_Pressed; 
    ...
    public SteamVR_Action_Vector3 m_TriggerhPos;
    ...
    {
        HandleHead();
        if (Trigger_Pressed.GetStateDown(m_Pose.inputSource)) {
            Control_hand();
        }
    ...
    private void HandleHead()
    {
        ...
        Vector3 tryit = GetComponent<Transform>().position;
    ...
    {
        Vector3 newPos = m_TriggerhPos[SteamVR_Input_Sources.LeftHand].delta;
