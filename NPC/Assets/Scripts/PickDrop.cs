...
public class PickDrop : MonoBehaviour
{
    ...
    public void Pickup()
    {
        ...
        if (m_object.GetComponent<Interactable>().m_ActiveHand != null)
        {
            m_object.GetComponent<Interactable>().m_ActiveHand.Drop();
        }
        Rigidbody target = m_object.GetComponent<Rigidbody>();
        m_Joint.connectedBody = target;
        m_object.GetComponent<Interactable>().m_ActiveHand = this;
    }
    public void Drop()
    {
        if (m_object == null) return;
        ...
        m_object.GetComponent<Interactable>().m_ActiveHand = null;
        m_object = null;
